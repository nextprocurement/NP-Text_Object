...
if __name__ == '__main__':
    ...
    parser.add_argument("--input", type=str, required=False, help="Path to the input file", default="/export/data_ml4ds/NextProcurement/PLACE/pliegos_objectives/all_extracted_12aug_es")
    parser.add_argument("--output", type=str, required=False, help="Path to the output file", default="/export/data_ml4ds/NextProcurement/PLACE/pliegos_objectives_preprocessed/all_extracted_12aug_es")
